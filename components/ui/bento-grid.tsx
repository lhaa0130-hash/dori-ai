...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      ...
      >
        {icon}
        <div className="font-sans font-bold text-stone-600 dark:text-stone-200 mb-2 mt-2">
          {title}
        </div>
        <div className="font-sans font-normal text-stone-600 text-xs dark:text-stone-300">
          {description}
        </div>
      </motion.div>
    </motion.div>
