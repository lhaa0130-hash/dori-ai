...
export default function HomeClient() {
  ...
  if (status === "unauthenticated") {
    return (
      <div className="mb-10 flex items-center justify-between py-4 px-5 rounded-2xl border border-neutral-100 dark:border-zinc-900 bg-neutral-50 dark:bg-zinc-900/40">
  ...
  /* ── 로그인 ── */
  return (
    <div className="mb-10 flex items-center justify-between py-4 px-5 rounded-2xl border border-neutral-100 dark:border-zinc-900">
      <div className="flex items-center gap-2.5">
        <span className="text-[20px]">🍭</span>
        <div>
