...
export default function Hero() {
  return (
    <section className="pt-8 pb-14">
      <h1 className="toss-fade-up toss-delay-0 text-[40px] sm:text-[54px] font-extrabold text-neutral-950 dark:text-white leading-[1.1] tracking-tight mb-5 break-keep">
        AI의 모든 것,
        <br />
        <span className="text-[#F9954E]">한 곳에서.</span>
      </h1>

      <p className="toss-fade-up toss-delay-1 text-[15px] text-neutral-500 dark:text-neutral-400 leading-[1.75] mb-9 break-keep">
