  ...
  return (
    <section className="pt-9 pb-7">
      <div className="flex items-center gap-1.5 mb-3.5 toss-fade-line">
        ...
        <span className="text-[11px] font-bold tracking-wide text-neutral-400 dark:text-neutral-500">{en ? "Create · Learn · Master with AI" : "AI로 만들고 · 배우고 · 익히고"}</span>
      </div>
      ...
      <p className="mt-2.5 text-[13px] sm:text-[15px] font-medium text-neutral-500 dark:text-neutral-400 break-keep toss-fade-line toss-delay-0">
        {en ? (
          <>All your scattered AI in one place. Everything, in <span className="font-bold text-[#F9954E]">illo.</span><span className="text-neutral-400 dark:text-neutral-500"> (illo = bring all your work into one)</span></>
        ) : (
          <>흩어진 AI를 한 곳에서. 모든 일을, <span className="font-bold text-[#F9954E]">일로.</span><span className="text-neutral-400 dark:text-neutral-500"> (일로 = 모든 일을 하나로, 이리로)</span></>
        )}
      </p>
    </section>
  );
