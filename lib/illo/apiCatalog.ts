    ...
    entries: [
      ...
      },
      {
        ...
        keySteps: [
          ...
          "키 복사 → 대리인 설정에 붙여넣기 (무료 티어로 바로 테스트)",
        ],
        note: "⚠️ 무료 티어는 입력 내용을 Google 제품 개선(학습)에 사용합니다. 민감한 자료는 유료 티어나 다른 모델을 쓰세요.",
      },
      {
        name: "로컬 AI (Ollama)", role: "recommend",
        use: "내 PC에서 직접 돌리는 무료 모델. 인터넷·API 키 없이 동작하고 자료가 밖으로 안 나감.",
        free: "완전 무료 — API 호출 비용 0원 (내 PC 전기·GPU만 씀)",
        topup: "충전 없음. 대신 PC 사양이 곧 성능(7~8B 모델은 8GB VRAM 권장).",
        keyUrl: "https://ollama.com/download",
        keySteps: [
          "ollama.com/download 에서 설치 (Windows/Mac/Linux)",
          "터미널에서 모델 받기 — 예: ollama pull exaone3.5:7.8b (한국어) 또는 ollama pull qwen2.5",
          "ollama serve 로 실행 (기본 주소 http://localhost:11434)",
          "브라우저에서 부르려면 CORS 허용이 필요 — 환경변수 OLLAMA_ORIGINS=* 설정 후 재시작",
        ],
        note: "⚠️ 지금 대리인에선 아직 실행되지 않습니다(선택만 가능). https 사이트에서 http://localhost 호출은 브라우저가 막을 수 있어, 실제 연결에는 별도 작업이 필요합니다. 원가 0원이라 우선순위는 높습니다.",
      },
    ],
