...
export interface ProjectItem {
  ...
  launchLabel?: string;
  launchDate?: string; // 정식 오픈일(YYYY-MM-DD). 이 날 전에는 'N월 N일 오픈' 배지로 표시
...
export const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    longDesc:
      "코인·국내주식·해외주식을 추세추종 전략과 엄격한 리스크 관리로 자동 매매하는 프로그램이에요. 손절·트레일링·분산·시장국면 필터로 손실을 통제하면서 상승 추세에 올라타고, 모든 거래(매수·매도 시간과 사유, 수익률)를 매일 사이트에 투명하게 공개합니다. 6월 한 달 모의(페이퍼)로 실제 시세에 맞춰 검증하고 7월 1일 정식 오픈해요. ⚠️ 투자에 완벽은 없으며 손실 위험이 있습니다.",
