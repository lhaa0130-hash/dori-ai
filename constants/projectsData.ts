...
const ALL_PROJECTS: ProjectItem[] = [
  {
    ...
    longDesc:
      "혼자 하는 싱글 RPG 게임을 처음부터 만들고 있습니다. 조선 무협의 세계관에 왕개미·산토끼·말벌·들개·삵·멧돼지 같은 동물 몬스터를 얹고, 조작은 캐주얼하게 — 세 가지를 섞은 게임입니다. 프로그래밍 경험 없이 검은 화면의 네모 한 칸에서 시작했고, 만들면서 막혔다 풀린 지점을 개발노트로 매일 남깁니다. 지금까지 21개 지역·몬스터 56종·전직 16갈래·무공 13종이 들어갔습니다. 설치나 회원가입 없이 브라우저에서 바로 실행됩니다.",
