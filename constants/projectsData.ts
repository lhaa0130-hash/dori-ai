...
export const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    longDesc:
      "요즘 아이들이 접하는 동물의 수는 점점 줄고 있어요. 동물도감은 아이들이 다양한 동물을 포켓몬처럼 친숙하게 알아가고, 엑셀처럼 셀을 클릭해서 원하는 조건의 동물을 찾을 수 있도록 만든 교육 프로젝트입니다. 먹이·색깔·크기·서식지 등 다양한 기준으로 동물을 탐험해보세요.",
    tags: ["어린이 교육", "동물 생태", "셀 검색"],
    launchHref: "/animal",
    launchLabel: "미리보기",
    features: [
      { icon: "🔎", title: "조건으로 찾기", detail: "곤충을 먹는 동물, 분홍색 동물, 손보다 작은 동물처럼 원하는 기준으로 검색해요." },
      { icon: "🃏", title: "도감 수집의 재미", detail: "포켓몬 도감처럼 하나씩 모으며 동물을 친숙하게 익혀요." },
