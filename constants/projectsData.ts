...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    longDesc:
      "요즘 아이들이 접하는 동물의 수는 점점 줄고 있어요. AI 동물도감은 실제 동물 사진과 3D 이미지를 함께 활용해 아이들이 300종+ 동물을 도감처럼 친숙하게 탐험하고, 색깔·먹이·크기·사는 곳 같은 특징으로 원하는 동물을 쉽게 찾을 수 있도록 만든 어린이 교육 서비스예요. 매일 5종씩 새 동물이 추가됩니다.",
  ...
  },
  {
    ...
    longDesc:
      "코인·국내주식·해외주식을 추세추종 전략과 엄격한 리스크 관리로 자동 매매해요. 손절·트레일링·분산·시장국면 필터로 손실을 통제하면서 상승 추세에 올라타고, 모든 거래 내역을 매일 투명하게 공개합니다. 현재 실제 시세로 성능을 검증하는 테스트 단계예요. ⚠️ 투자에 완벽은 없으며 손실 위험이 있습니다.",
    tags: ["자동매매", "리스크 관리", "거래 투명 공개"],
    launchHref: "/trader",
    launchLabel: "테스트 현황 보기",
    features: [
  ...
  },
  {
    ...
    longDesc:
      "하고 싶은 일을 고르면 그 작업에 딱 맞는 AI가 이미 연결돼 있어요. 글쓰기·마케팅·고객응대·요약·번역까지 복잡한 설정 없이 원하는 업무를 처리할 수 있는 AI 사무실입니다. 현재 기능을 다듬는 테스트 단계예요.",
    tags: ["1인 사업", "AI 자동화", "테스트 중"],
    launchHref: "/illo/app",
