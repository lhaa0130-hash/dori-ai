...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    longDesc:
      "지구본을 손으로 돌려보고, 평면 세계지도로 전체를 한눈에 봅니다. 나라를 누르면 면적·인구·GDP·1인당 GDP·수도·통화·언어·시간대가 바로 나오고, 세계 순위와 인접 국가까지 이어서 볼 수 있어요. 색 기준을 바꾸면 지도 전체가 그 지표로 다시 칠해져 나라끼리 비교가 쉬워집니다. 수치는 세계은행·world-countries 공개 데이터를 기준 연도와 함께 표시합니다.",
