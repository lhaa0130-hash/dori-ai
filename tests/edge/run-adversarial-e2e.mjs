...
// 인스턴스 정의 — 롤아웃/관리자 조합
// ⚠️ run-edge-e2e.mjs 가 8788·8790·8792·8793·8794 를 쓴다 → 겹치지 않는 대역을 쓴다.
const P = { ALL: 8810, MISSING: 8811, CANARY: 8812, OFF: 8813, ARTICLE_ONLY: 8814 };
...
const jbody = (o) => JSON.stringify(withCandyOwner(o));
