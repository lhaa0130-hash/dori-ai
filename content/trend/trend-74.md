...
![AI 양자컴퓨팅 암호화 위협 사이버보안](/images/trend/trend-74-1.png)
...
논문 공동 저자 로버트 황(Robert Huang)은 핵심 알고리즘의 성능이 처음에는 목표보다 "약 1,000배 낮았다"고 밝혔다. 이를 해결하기 위해 그는 Google Gemini와 Anthropic Claude 등 LLM을 활용한 오픈소스 진화 알고리즘 도구 **OpenEvolve**를 적용했다.
