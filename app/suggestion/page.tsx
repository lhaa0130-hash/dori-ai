                ...
                {!showForm ? (
                    ...
                    <div className="p-6 rounded-2xl bg-white dark:bg-zinc-950 border border-stone-100 dark:border-zinc-900 mb-6">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            {/* 이름 */}
                            <div>
                                <label className="block text-[11px] font-bold mb-2 text-stone-500 dark:text-stone-400">이름 *</label>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <div className="flex-1">
                                    <label className="block text-[11px] font-bold mb-2 text-stone-500 dark:text-stone-400">유형 *</label>
                                ...
                                <div className="flex-1">
                                    <label className="block text-[11px] font-bold mb-2 text-stone-500 dark:text-stone-400">우선순위</label>
                                    <div className="relative">
                            ...
                            {/* 내용 */}
                            <div>
                                <label className="block text-[11px] font-bold mb-2 text-stone-500 dark:text-stone-400">내용 * (10자 이상)</label>
                                ...
                                <p className="text-[11px] text-stone-400 mt-1 text-right">{message.length}자</p>
                            </div>
            ...
            <section className="pb-12">
                {suggestions.length === 0 ? (
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-[15px] font-extrabold mb-2 text-stone-900 dark:text-white">아직 건의사항이 없습니다</h3>
                        <p className="text-stone-500 dark:text-stone-400 text-[13px]">첫 번째 건의사항을 작성해보세요!</p>
                    </div>
                ) : (
