...
export default function PrivacyClient() {
  ...
  const sections = [
    ...
    {
      q: "제6조 (개인정보의 국외 이전)",
      a: "① 회사는 원활하고 안정적인 서비스 제공을 위하여 국외에 소재한 클라우드 인프라 및 분석·광고 서비스를 이용하고 있으며, 이에 따라 이용자의 개인정보가 아래와 같이 국외로 이전됩니다. 회원 인증·데이터 저장·웹사이트 제공을 위한 처리위탁·보관에 수반되는 국외 이전에 대해서는 「개인정보 보호법」 제28조의8 제1항 제3호에 따라 본 개인정보 처리방침에 이전에 관한 사항을 공개함으로써 이용자에게 알려드립니다.\n\n② 국외 이전 현황\n\n─────────────────────────────\n▶ 이전받는 자 : Google LLC\n• 이전 국가 : 미국 (United States)\n• 이전받는 자의 연락처 : Google 개인정보처리방침(policies.google.com/privacy) 참조\n• 이전 항목 : 이메일, 닉네임, 프로필 정보, 서비스 활동기록\n• 이전 목적 : 회원 인증, 데이터베이스(Firestore)·파일 저장 등 회원 DB 운영\n• 이전 일시 및 방법 : 서비스 이용 시점에 정보통신망을 통한 전송(수시)\n• 보유·이용 기간 : 회원 탈퇴 또는 위탁계약 종료 시까지\n─────────────────────────────\n▶ 이전받는 자 : Cloudflare, Inc.\n• 이전 국가 : 미국 (United States)\n• 이전받는 자의 연락처 : Cloudflare 개인정보처리방침(www.cloudflare.com/privacypolicy) 참조\n• 이전 항목 : 접속 로그, 접속 IP 주소\n• 이전 목적 : 웹사이트 호스팅, 콘텐츠 전송(CDN) 및 보안\n• 이전 일시 및 방법 : 서비스 접속 시점에 정보통신망을 통한 전송(수시)\n• 보유·이용 기간 : 서비스 제공 목적 달성 시 또는 위탁계약 종료 시까지\n─────────────────────────────\n▶ 이전받는 자 : Google LLC (Google Analytics · Google AdSense)\n• 이전 국가 : 미국 (United States)\n• 이전받는 자의 연락처 : Google 개인정보처리방침(policies.google.com/privacy) 참조\n• 이전 항목 : 쿠키, 접속 로그, 서비스 이용기록, 기기·브라우저 정보\n• 이전 목적 : 서비스 이용 통계 분석 및 맞춤형 광고 제공\n• 이전 일시 및 방법 : 서비스 이용 시점에 정보통신망을 통한 전송(수시)\n• 보유·이용 기간 : 해당 서비스의 정책에 따른 보관 기간 또는 이용 목적 달성 시까지\n─────────────────────────────\n▶ 이전받는 자 : Microsoft Corporation (Microsoft Clarity)\n• 이전 국가 : 미국 (United States)\n• 이전받는 자의 연락처 : Microsoft 개인정보처리방침(privacy.microsoft.com) 참조\n• 이전 항목 : 쿠키, 접속 로그, 페이지 이용 행태(사용성) 정보\n• 이전 목적 : 사용성 통계 분석 및 서비스 개선\n• 이전 일시 및 방법 : 서비스 이용 시점에 정보통신망을 통한 전송(수시)\n• 보유·이용 기간 : 해당 서비스의 정책에 따른 보관 기간 또는 이용 목적 달성 시까지\n─────────────────────────────\n\n③ 국외 이전에 대한 이용자의 선택권 및 그 효과\n• 회원 인증·데이터 저장·웹사이트 제공을 위한 이전(Google LLC의 회원 DB 운영, Cloudflare의 호스팅)은 서비스의 본질적 기능 수행에 필수적이므로, 이를 원하지 않으시는 경우 회원 탈퇴 또는 서비스 이용 중단을 통하여 개인정보의 이전을 중단하실 수 있습니다.\n• 통계 분석 및 맞춤형 광고와 관련한 개인정보 이전(Google Analytics·AdSense, Microsoft Clarity)은 웹 브라우저의 쿠키 차단 설정 또는 각 서비스가 제공하는 수집 거부(옵트아웃) 도구를 통하여 개별적으로 거부하실 수 있으며, 이 경우에도 필수 서비스 이용에는 지장이 없습니다.\n• 회사는 국외 이전에 관하여 「개인정보 보호법」 제28조의8 및 제28조의9가 요구하는 보호조치를 이전받는 자와 함께 이행하도록 합니다."
    },
    {
      q: "제7조 (개인정보의 파기 절차 및 방법)",
    ...
    {
      q: "제8조 (정보주체와 법정대리인의 권리·의무 및 행사방법)",
    ...
    {
      q: "제9조 (만 14세 미만 아동의 개인정보)",
      a: "① illo(이하 \"회사\")는 원칙적으로 만 14세 이상인 자를 대상으로 서비스를 제공하며, 회원 가입은 만 14세 이상인 경우에 한하여 가능합니다.\n\n② 만 14세 미만 아동이 회원으로 가입하거나 서비스를 이용하고자 하는 경우, 「개인정보 보호법」 제22조의2에 따라 법정대리인(부모 등)의 동의를 받아야 합니다. 회사는 법정대리인의 동의를 받기 위하여 아동으로부터 법정대리인의 성명·연락처 등 최소한의 정보를 수집할 수 있습니다.\n\n③ 법정대리인 동의 확인 방법\n• 법정대리인의 이메일 등 연락처를 통한 동의 의사 확인\n• 회사가 별도로 마련한 동의 확인 절차를 통한 확인\n• 그 밖에 관계법령이 정하는 방법에 준하는 절차\n회사는 만 14세 미만 아동의 개인정보를 처리하는 경우 그 법정대리인의 동의를 받았는지 확인하며, 동의가 확인되지 않는 경우 해당 개인정보를 지체 없이 파기합니다.\n\n④ 법정대리인의 권리\n• 법정대리인은 아동의 개인정보에 대한 열람, 정정·삭제, 처리정지 및 동의 철회를 언제든지 요구할 수 있습니다.\n• 회사는 법정대리인이 동의를 철회하는 경우 지체 없이 필요한 조치를 취합니다.\n\n⑤ 회사는 만 14세 미만 아동의 개인정보 보호를 위하여, 아동을 대상으로 그 법정대리인의 동의가 필요한 재화·용역을 광고하거나 아동에게 부당하게 개인정보 제공을 유도하지 않습니다.\n\n※ 만 14세 미만 아동 또는 그 법정대리인은 아동의 개인정보와 관련한 문의를 개인정보 보호책임자의 이메일(illo@illo.im)로 하실 수 있습니다."
    },
    {
      q: "제10조 (개인정보의 안전성 확보 조치)",
    ...
    {
      q: "제12조 (개인정보 보호책임자 및 담당부서)",
      a: "① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 문의·불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자 및 담당부서를 지정하고 있습니다.\n\n▶ 개인정보 보호책임자(CPO)\n• 직책 : illo 운영책임자\n• 이메일 : illo@illo.im\n\n▶ 개인정보 보호 담당부서\n• 부서명 : illo 운영팀\n• 이메일 : illo@illo.im\n\n※ 개인정보 보호책임자의 성명은 개인정보 보호를 위하여 비공개하며, 직책·담당부서 및 대표 연락처(이메일)를 통하여 문의·처리 업무를 수행합니다.\n\n② 이용자는 회사의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 이용자의 문의에 대하여 지체 없이 답변 및 처리해 드립니다.\n\n③ 회사는 개인정보의 처리와 관련하여 관계법령이 정한 바에 따라 개인정보 보호책임자의 책임과 역할을 성실히 이행합니다."
    },
    {
      q: "제13조 (개인정보 침해 관련 구제 방법)",
      a: "이용자가 개인정보 침해에 대한 피해구제, 상담 등이 필요한 경우에는 아래의 기관에 문의하시기 바랍니다.\n\n▶ 개인정보 침해신고센터 (한국인터넷진흥원 운영)\n• 홈페이지: privacy.kisa.or.kr\n• 전화: (국번없이) 118\n\n▶ 개인정보 분쟁조정위원회\n• 홈페이지: www.kopico.go.kr\n• 전화: (국번없이) 1833-6972\n\n▶ 대검찰청 사이버수사과\n• 홈페이지: www.spo.go.kr\n• 전화: (국번없이) 1301\n\n▶ 경찰청 사이버수사국\n• 홈페이지: ecrm.cyber.go.kr\n• 전화: (국번없이) 182"
    },
    {
      q: "제14조 (개인정보 처리방침의 변경)",
      ...
      <section className="relative pt-4 sm:pt-16 pb-8 sm:pb-16 px-4 sm:px-6 text-center z-10">
        <div className="max-w-3xl mx-auto animate-fade-in flex flex-col items-center">
          ...
          <p className="text-xs text-neutral-400 dark:text-neutral-500 mt-3">
            최종 수정일: 2026년 7월 4일 · 시행일: 2026년 2월 16일
          </p>
        </div>
      </section>
