    ...
    <main className="page">
      ...
      <section className="top-section">
        ...
        <div className="bento-grid fade-in-up delay-1">
          ...
          {/* [2. Insight] 인사이트 (우측 상단, 1x1) */}
          <Link href="/insight" className="bento-card">
            <div className="card-content">
          ...
          {/* [3. Academy] 아카데미 (우측 중단, 1x1) */}
          <Link href="/education" className="bento-card">
            <div className="card-content">
              <div className="icon-box glass">🎓</div>
              <h3>아카데미</h3>
          ...
          {/* [4. Resources] 자료실 (좌측 하단, 1x1) */}
          <Link href="/resources" className="bento-card">
            <div className="card-content">
              <div className="icon-box glass">📂</div>
              <h3>무료 자료실</h3>
          ...
          {/* [5. Community] 커뮤니티 (우측 하단, 2x1 와이드) */}
      ...
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Hero Text */
        .top-header { text-align: center; margin-bottom: 60px; }
