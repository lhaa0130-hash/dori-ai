...
export const metadata = createMetadata({
  ...
  description: "ChatGPT, Claude, Gemini, DeepSeek 등 전 세계 인기 AI 모델의 사용량·지능·속도·가격을 한눈에 비교하고, 토큰 수만 넣으면 모델별 월 비용을 자동 계산합니다. 6시간마다 갱신.",
  path: "/ai-models",
  keywords: [
...
const faqLd = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "데이터는 얼마나 최신인가요?", acceptedAnswer: { "@type": "Answer", text: "OpenRouter의 실제 사용량·가격 데이터를 6시간마다 자동으로 갱신합니다." } },
