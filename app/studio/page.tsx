...
export default function StudioPage() {
  ...
  function loadTools() {
    ...
    if (savedTools.length === 0) {
      // ★ 70개 이상의 툴 데이터 복구 (rating, reviews 모두 0으로 초기화)
      const initialData = [
        // 1. [TEXT & LLM]
        ...
        { id: 102, title: "Claude", category: "TEXT", desc: "자연스러운 한국어와 뛰어난 코딩/작문 능력", logo: "https://logo.clearbit.com/anthropic.com", price: "Free", rating: 0, reviews: 0, link: "https://claude.ai", history: "OpenAI 출신 연구원들이 설립. 안전하고 윤리적인 AI를 지향.", news: "Claude 3.5 Sonnet 출시 이후 성능 입증.", commentsList: [] },
        { id: 103, title: "Perplexity", category: "TEXT", desc: "실시간 웹 검색 기반의 AI 검색엔진", logo: "https://logo.clearbit.com/perplexity.ai", price: "Freemium", rating: 0, reviews: 0, link: "https://www.perplexity.ai", history: "전통적인 검색엔진을 대체하기 위해 등장.", news: "기업가치 급상승 및 Pro Search 기능 고도화.", commentsList: [] },
        ...
        { id: 202, title: "Stable Diffusion", category: "IMAGE", desc: "내 PC에 설치해 쓰는 무한한 자유도의 툴", logo: "https://logo.clearbit.com/stability.ai", price: "Free", rating: 0, reviews: 0, link: "https://stability.ai", history: "오픈소스 생성형 AI의 표준. 다양한 파생 모델 보유.", news: "SD3 모델 발표.", commentsList: [] },
        ...
        { id: 207, title: "Ideogram", category: "IMAGE", desc: "이미지 내 타이포그래피(글자) 표현 최강", logo: "https://logo.clearbit.com/ideogram.ai", price: "Free", rating: 0, reviews: 0, link: "https://ideogram.ai", history: "텍스트 렌더링 문제 해결.", news: "v1.0 모델 출시.", commentsList: [] },
        ...
        { id: 209, title: "Civitai", category: "IMAGE", desc: "전 세계 최대의 AI 모델 공유 커뮤니티", logo: "https://logo.clearbit.com/civitai.com", price: "Free", rating: 0, reviews: 0, link: "https://civitai.com", history: "스테이블 디퓨전 모델, 로라 공유 허브.", news: "온사이트 생성 기능 지원.", commentsList: [] },
        { id: 210, title: "Recraft", category: "IMAGE", desc: "벡터 그래픽 및 아이콘 생성", logo: "https://logo.clearbit.com/recraft.ai", price: "Free", rating: 0, reviews: 0, link: "https://www.recraft.ai", history: "디자이너를 위한 벡터 기반 생성형 AI.", news: "피그마 플러그인 지원.", commentsList: [] },

        // 3. [VIDEO Creation]
        { id: 301, title: "Runway", category: "VIDEO", desc: "텍스트로 영화 같은 영상을 만드는 툴", logo: "https://logo.clearbit.com/runwayml.com", price: "Freemium", rating: 0, reviews: 0, link: "https://runwayml.com", history: "영상 생성 AI의 선구자.", news: "Gen-3 Alpha 공개.", commentsList: [] },
  ...
  const handleVote = (id: number, score: number) => {
    ...
    localStorage.setItem("dori_tools_v11", JSON.stringify(sortedTools)); // Update key
    localStorage.setItem("dori_my_votes_v4", JSON.stringify(newMyVotes)); // Update key
  ...
  return (
    <main className="page">
      ...
      <section className="container section" style={{ minHeight: "80vh", paddingTop: "60px" }}>
        <div className="page-header">
          ...
          <p className="page-desc">
            Top AI tools curated by community votes.<br/>
            Discover, rate, and review the best tools.
          </p>
        </div>
      ...
      <style jsx global>{`
        ...
        .resource-card:hover { transform: translateY(-4px); box-shadow: 0 12px 30px rgba(0,0,0,0.08); border-color: var(--blue); }
        ...
        .review-form button { width: 100%; padding: 10px; background: var(--text-main); color: white; border-radius: 8px; font-weight: 700; cursor: pointer; }
