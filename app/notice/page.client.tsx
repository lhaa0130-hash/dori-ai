...
const notices: NoticeItem[] = [
    {
        ...
        type: "업데이트",
        version: "v5.0.0",
        title: "AI 소셜 네트워크 전환 · 코지홈 대확장 · 상점 개편",
        content: "안녕하세요, illo.im을 만드는 illo입니다.\nillo.im이 'AI 소셜 네트워크 + 커뮤니티'로 한 단계 진화했습니다. (v5.0)\n\n🪐 1. 소셜 네트워크\n• 팔로우 — 친구(상호)와 별개로, 마음에 드는 사람을 팔로우할 수 있어요. 프로필에 팔로워·팔로잉·게시물 수가 표시됩니다.\n• 탐색 — 인기/최신/팔로잉 피드와 추천 팔로우로 새로운 사람과 글을 발견하세요. (마이페이지 › 내 공간 › 탐색)\n• 방명록 — 다른 사람 코지홈에 글을 남기고, 작성자 이름을 누르면 그 사람의 코지홈으로 바로 이동합니다.\n\n🏠 2. 코지홈 꾸미기 대확장\n• 배경·테두리·이름효과·배너효과·칭호·스티커에 더해 펫·캐릭터(동물 30종)와 미니룸 소품까지 추가됐어요.\n• 무드 이모지·관심사 태그·프로필 공유(🔗)로 나만의 공간을 완성하세요.\n\n🛍️ 3. 솜사탕 상점 개편\n• 구매 전 '👁 입어보기' — 내 코지홈에 적용된 모습을 미리 확인하고 구매할 수 있어요.\n• 아이템 대량 추가(무료/유료 구분, 노멀~레전드 희귀도), 코지홈↔상점 탭으로 자유롭게 오갈 수 있습니다.\n\n🤖 4. AI 도구 순위 갱신\n• LLM 순위를 OpenRouter 실사용량(2026.06) 기준으로 반영했어요.\n\n🔧 5. 속도 · 편의\n• 캐시·폰트·번들 최적화로 더 빠르게, 헤더·푸터 메뉴도 깔끔하게 정리했습니다.\n\n앞으로도 더 즐거운 illo.im이 되도록 계속 다듬겠습니다. 감사합니다!",
        date: "2026-06-15",
        pinned: true,
    },
    {
    ...
    },
    {
        ...
        type: "공지",
        version: "v1.0.0",
        title: "illo 서비스 정식 오픈 안내",
        content: "안녕하세요! illo가 정식 오픈했습니다. 🎉\n\nillo는 최신 AI 도구 정보, 인사이트, 커뮤니티, 교육 콘텐츠를 한곳에서 제공하는 종합 AI 플랫폼입니다.\n\n현재 제공되는 서비스 (v1.0):\n• AI 도구 검색 및 비교\n• AI 인사이트 기사\n• 커뮤니티 게시판\n• 미니게임 (베타)\n\n앞으로도 지속적으로 새로운 기능과 콘텐츠를 추가할 예정입니다. 많은 관심과 피드백 부탁드립니다!",
        date: "2026-02-16",
        pinned: false,
    },
];
